    ...
    render: function() {
        ...
        return (
            React.createElement("div", null, 
                React.createElement("div", {onClick: this.closeMenu, onContextMenu: this.closeMenu, className: "modal-dialog-layer"}), 
                React.createElement("div", {className: "dropdown-settings", style: {zIndex: 5001}}, 
                    React.createElement("div", {className: "border-block"}, 
                        React.createElement("div", {className: "rows-group"}, 
                        ...
                        this.state.settingsOpened ?
                            React.createElement("div", {className: "rows-group disabled"}, 
                                React.createElement("div", {className: "menu-row", onClick: stopEventBubble}, 
                            ...
                            React.createElement("div", {className: "rows-group"}, 
                                React.createElement("div", {className: rjs_class({
                                 ...
                                 this.state.shutDownWhenDone || this.state.shutDownGroupOpened ?
                                    ...
                                    React.createElement("div", {className: "shutdown_group"}, 
                                        React.createElement("div", {className: rjs_class({
                                            'menu-row': true,
                        ...
                        */
                        React.createElement("div", {className: "rows-group"}, 
                            ...
                            React.createElement("div", {className: "menu-row", 
                                ...
                                this.__('Check for updates') + (fdmApp.platform == 'mac' ? '...' : ''))
                                : null, 
                            React.createElement("div", {className: "menu-row", 
                                 onClick: _.bind(menu.shareWithFriends, menu)}, 
                                this.__('Share with friends') + (fdmApp.platform == 'mac' ? '...' : '')), 
                            !fdmApp.vicoinIsInstalled ?
                            React.createElement("div", {className: "menu-row", 
                                 onClick: _.bind(menu.vicoinsBundle, menu)}, 
                                this.__('Special offer') + (fdmApp.platform == 'mac' ? '...' : ''))
                                : null, 
                            React.createElement("div", {className: "menu-row", 
                                 onClick: _.bind(menu.openAbout, menu)}, __('About Free Download Manager')), 
                            React.createElement("hr", null)
                        ), 
                        React.createElement("div", {className: "rows-group"}, 
                            React.createElement("div", {className: "menu-row", 
