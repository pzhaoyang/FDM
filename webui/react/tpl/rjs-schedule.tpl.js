    ...
    render: function() {
        ...
        return (
            ...
            React.createElement("div", null, 
                ...
                React.createElement("div", {className: "wrapper_days"}, 
                    ...
                    !this.props.type || this.props.type != 'wizard' ?
                        React.createElement("div", null, 
                            ...
                            React.createElement("label", {htmlFor: "enable-scheduler"}, 
                                __('Enable Scheduler')
                            )
                        )
                        : null, 

                    React.createElement("input", {defaultChecked: days[7], checked: days[7], 
                           onChange: _.partial(this.toggleDay, 7), 
                           disabled: !this.props.enableScheduler, 
                           type: "checkbox", id: "day7"}), 
                    React.createElement("label", {htmlFor: "day7"}, __('Sun')), 

                    React.createElement("input", {defaultChecked: days[1], checked: days[1], 
                           onChange: _.partial(this.toggleDay, 1), 
                           disabled: !this.props.enableScheduler, 
                           type: "checkbox", id: "day1"}), 
                    React.createElement("label", {htmlFor: "day1"}, __('Mon')), 

                    React.createElement("input", {defaultChecked: days[2], checked: days[2], 
                           onChange: _.partial(this.toggleDay, 2), 
                           disabled: !this.props.enableScheduler, 
                           type: "checkbox", id: "day2"}), 
                    React.createElement("label", {htmlFor: "day2"}, __('Tue')), 

                    React.createElement("input", {defaultChecked: days[3], checked: days[3], 
                           onChange: _.partial(this.toggleDay, 3), 
                           disabled: !this.props.enableScheduler, 
                           type: "checkbox", id: "day3"}), 
                    React.createElement("label", {htmlFor: "day3"}, __('Wed')), 

                    React.createElement("input", {defaultChecked: days[4], checked: days[4], 
                           onChange: _.partial(this.toggleDay, 4), 
                           disabled: !this.props.enableScheduler, 
                           type: "checkbox", id: "day4"}), 
                    React.createElement("label", {htmlFor: "day4"}, __('Thu')), 

                    React.createElement("input", {defaultChecked: days[5], checked: days[5], 
                           onChange: _.partial(this.toggleDay, 5), 
                           disabled: !this.props.enableScheduler, 
                           type: "checkbox", id: "day5"}), 
                    React.createElement("label", {htmlFor: "day5"}, __('Fri')), 

                    React.createElement("input", {defaultChecked: days[6], checked: days[6], 
                           onChange: _.partial(this.toggleDay, 6), 
                           disabled: !this.props.enableScheduler, 
                           type: "checkbox", id: "day6"}), 
                    React.createElement("label", {htmlFor: "day6"}, __('Sat'))
                ...
                React.createElement("div", {className: rjs_class({
                    ...
                    React.createElement("span", null, __('From:')), 
                    React.createElement("div", {className: "choose"}, 
                        React.createElement("div", {className: "transparent_select", 
                             onClick: _.partial(this.closeSelectClick, 'start'), 
                             style: {display: this.state.timeStartState != this.selectStates.closed ? 'block' : 'none'}}), 
                        React.createElement("div", {className: rjs_class({
                            ...
                            this.state.timeStartState == this.selectStates.input ?
                                React.createElement("span", {onClick: stopEventBubble, className: "wrap_numbers"}, 
                                                    React.createElement("input", {defaultValue: this.state.timeStartInputH, 
                                                    ...
                                                    React.createElement("input", {defaultValue: this.state.timeStartInputM, 
                                ...
                                :
                                React.createElement("span", null, this.msecToTime(startTime)), 
                            

                            React.createElement("div", {className: "dropdown_button", onClick: _.partial(this.dropdownButtonMouseDown, 'start')}), 

                            React.createElement("div", {className: "list", style: {display: this.state.timeStartState != this.selectStates.closed ? 'block' : 'none'}}, 

                                _.map(this.schedulerSelectIntervals, function(val, i){

                                    return (
                                        React.createElement("div", {key: i, onClick: _.partial(this.setTime, 'start', val)}, React.createElement("span", null, this.msecToTime(val)))
                                    );
                    ...
                    React.createElement("span", null, __('To:')), 
                    React.createElement("div", {className: "choose"}, 
                        React.createElement("div", {className: "transparent_select", 
                             onClick: _.partial(this.closeSelectClick, 'end'), 
                             style: {display: this.state.timeEndState != this.selectStates.closed ? 'block' : 'none'}}), 
                        React.createElement("div", {className: rjs_class({
                                    wrapper_inselect: true,
                                    top_position: this.props.top_position
                                }), 
                            ...
                            this.state.timeEndState == this.selectStates.input ?
                                React.createElement("span", {onClick: stopEventBubble, className: "wrap_numbers"}, 
                                                    React.createElement("input", {defaultValue: this.state.timeEndInputH, 
                                                           value: this.state.timeEndInputH, 
                                                           onChange: _.partial(this.setInputTime, 'end', 'h'), 
                                                           onKeyDown: _.partial(this.inputKeyDown, 'end'), 
                                                           type: "number", max: "23", min: "0"}), " :", 
                                                    React.createElement("input", {defaultValue: this.state.timeEndInputM, 
                                ...
                                :
                                React.createElement("span", {onClick: _.partial(this.closeSelectClick, 'end')}, this.msecToTime(endTime)), 
                            

                            React.createElement("div", {className: "dropdown_button", onClick: _.partial(this.dropdownButtonMouseDown, 'end')}), 

                            React.createElement("div", {className: "list", style: {display: this.state.timeEndState != this.selectStates.closed ? 'block' : 'none'}}, 

                                _.map(this.schedulerSelectIntervals, function(val, i){

                                    return (
                                        React.createElement("div", {key: i, onClick: _.partial(this.setTime, 'end', val)}, React.createElement("span", null, this.msecToTime(val)))
                                    );
...
var ScheduleDialog = React.createClass({displayName: "ScheduleDialog",
    ...
    render: function() {
        ...
        return (
            ...
            React.createElement("div", {id: "download-popup-overlay2", 
                ...
                React.createElement("div", {className: "popup_window scheduler"}, 
                    React.createElement("div", null, 

                        React.createElement("div", {className: "header"}, 
                            React.createElement("div", null, __('Sсheduler')), 
                            React.createElement("div", {className: "close_button", onClick: this.close})
                        ), 

                        React.createElement("div", {className: "center center_add_ul"}, 
                            React.createElement("div", {className: "note"}, __('Start and pause downloads at specified time')), 

                            React.createElement(Schedule, {timetable: this.state.timetable, 
